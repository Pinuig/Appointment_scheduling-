...
if(isset($_POST['save-appointment']))
{
      ...
      $update_query = mysqli_query($connection, "update tbl_appointment set Name='$Name', Email='$Email', doctor_name='$doctor_name', specialization='$specialization', Date='$Date',  Phone='$Phone', message='$message'  where id='$id'");
      if($update_query>0)
      {
